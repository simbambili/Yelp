...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: String?, offset: String?, completion: ([Business]!, NSError!) -> Void) -> Void {
